...
macros.RandomAnalysis.MultiChannelConfiguration([0, 3, 4], channelTypes, [0.8, 1.0, 1.5], Shared.Constants.CONTROLSTRATEGY.CONTROLSTRATEGY_WEIGHTING, samples, 0, Shared.Constants.WINDOWS.WINDOWSHANNING);
...
macros.RandomAnalysis.SendHarmonic(0, samples, Fs, 2000);%10000);
%macros.RandomAnalysis.SendHarmonic(5, samples, Fs, 5000);
macros.RandomAnalysis.SendHarmonic(3, samples, Fs, 5000);
